...
namespace Rotation.GameObjects.sTests.EventsSpecs
{
    public class RemoveFoundBlocksEventHandlerSpecs
    {
        ...
        public void CanCorrectlyRemoveFoundBlocksWhenOneBlockFound()
        {
                ...
                .Context(() =>
                    {
                        ...
                        handler = new RemoveFoundBlocksEventHandler(board, animationStore);
            ...
            "Then square 4, 1 should not contain colour 3"
                .Observation(() => board[4, 1].Colour.ShouldNotEqual(3));

            "Then square 4, 0 should not contain colour 1"
                .Observation(() => board[4, 0].Colour.ShouldNotEqual(1));
            ...
            "Then square 5, 2 should not contain colour 8"
                .Observation(() => board[5, 2].Colour.ShouldNotEqual(8));

            "Then square 5, 1 should not contain colour 4"
                .Observation(() => board[5, 1].Colour.ShouldNotEqual(4));
